"""
================================================================================
  P_Long_1H_V13 — Donchian + MFI, H1触发, 最多5手, 自管持仓 (白银做多, 新标准)
================================================================================
...
class Params(BaseParams):
    ...
    instrument_id: str = Field(default="p2609", title="合约代码")
...
class P_Long_1H_V13_Donchian_MFI(BaseStrategy):
    """棕榈油 H1 做多 — Donchian + MFI (QBase_v3 V13), 新标准版."""
