"""
================================================================================
  CU_Long_1H_V8 — Donchian + ADX, H1触发, 最多5手, 自管持仓 (新标准)
================================================================================
...
class Params(BaseParams):
    ...
    instrument_id: str = Field(default="cu2606", title="合约代码")
...
class CU_Long_1H_V8_Donchian_ADX_Filter(BaseStrategy):
    """铜 H1 做多 — 新标准版 (自管持仓 + 全 UI + 全日志)."""
