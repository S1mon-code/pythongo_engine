"""
================================================================================
  CU_Short_Portfolio_V26_V29 — 铜做空组合 (H1+H4 双时间框架)
================================================================================
...
STRATEGY_NAME = "CU_Short_Portfolio_V26_V29"
...
FORECAST_CAP = 20.0
ANNUAL_FACTOR = 252 * 3          # H4: ~3 bars/day
...
class CU_Short_Portfolio_V26_V29(BaseStrategy):
    """铜做空组合 — V26(H1) + V29(H4) 双时间框架"""
    ...
    def _on_bar_h1(self, kline: KLineData):
        ...
        self.output(f"[IND H1] V26={self._signal_v26:.3f}")
    ...
    def _on_bar_h4(self, kline: KLineData):
        ...
        self.output(f"[IND H4] V26={self._signal_v26:.3f} V29={self._signal_v29:.3f} combined={combined:.3f} forecast={forecast:.1f} close={close:.1f}")
        ...
        if net_pos > 0:
            ...
            # Equity/Portfolio stops (方向无关, RiskManager处理)
